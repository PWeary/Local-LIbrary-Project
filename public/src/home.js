/*Write a function that returns the total number of book objects inside the array, can use the .length property*/
function getTotalBooksCount(books) {
  return books.length;
}

/*Write a function that returns the total number of account objects inside the array, can use the .length property*/
function getTotalAccountsCount(accounts) {
  return accounts.length;
}

/*Write a function that returns the total number of borrowed books, can use the filter() method*/
